...
contract Ownable {
    ...
    event onwershiptransferred(address newowner, address previousowner);
    //  2) create an internal constructor that sets the _owner var to the creater of the contract 
    constructor () internal {
       _owner=msg.sender;
       emit onwershiptransferred(msg.sender, address(0));
    }
    //  3) create an 'onlyOwner' modifier that throws if called by any account other than the owner.
    modifier onlyOwner{
        require(_owner==msg.sender,"call is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        emit onwershiptransferred(newOwner, _owner);
        _owner=newOwner;
    }
}
...
contract Pausable is Ownable{
    ...
    function setpaused(bool ispaused) public view onlyOwner {
        require(paused!=_paused,"contract has been paused");
        ispaused=_paused;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId)!=to,"Given address is the same as current owner of the tokenId");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner()|| isApprovedForAll(owner, msg.sender), "msg sender is not the owner of the contract or isApprovedForAll() is fause");
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require (_exists(tokenId),"toekn approval does not exist");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId)|| to!=address(0), "tokenId does not exist or given address is invalid");
...
contract CustomERC721Token is ERC721Metadata{
    constructor() public
    ERC721Metadata("Token","Sunflower","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){}
